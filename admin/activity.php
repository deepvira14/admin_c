...
<head>
    ...
    <title>Ocean Transworld Logistics</title>
    <!-- Bootstrap Core CSS -->
...
<!--                        <h3 class="text-themecolor">Dashboard</h3>-->
                                    ...
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
                                        ...
                                        <tbody>
                                           <tr>
                                                ...
                                                <td><span class="label label-success">Occupied</span> </td>
                                                <td>Hritik Roshan</td>
                                                <td>13-10-2017</td>
                                                <td>
                                                  <a href="Govinda_mauli_exp_details.php">  <button type="button" class="btn waves-effect waves-light btn-outline-success">Expense</button>
                                                  </a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="label label-warning">Idle</span> </td>
                                                <td>Hritik Roshan</td>
                                                <td>12-10-2017</td>
                                                <td>
                                                 <a href="raja_expense_details.php">   <button type="button" class="btn waves-effect waves-light btn-outline-success">Expense</button>
                                                    </a>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="Delete"><i class="ti-close" aria-hidden="true"></i></button>
                                            ...
                                            <tr>
                                                ...
                                                <td>12-10-2017</td>
                                                <td>
                                                    <button type="button" class="btn waves-effect waves-light btn-outline-success">Expense</button>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="Delete"><i class="ti-close" aria-hidden="true"></i></button>
                                                </td>
            ...
            <footer class="footer">  © 2019 Ocean Transworld Logistics Pvt Ltd </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
